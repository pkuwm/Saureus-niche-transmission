...
# Plot a phylogenetic tree with isolate metadata and gene annotations.
# Input: allsau_tree.fasta.treefile and anno_for_all_new.csv.
# Output: tree_with_annotation.pdf.
...
tree <- read.tree("allsau_tree.fasta.treefile")
anno <- read.csv("anno_for_all_new.csv", header = TRUE)
