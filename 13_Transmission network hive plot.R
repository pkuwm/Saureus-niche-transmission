...
# Summarize transmission links between sampling locations and draw ST398 hive plots.
# Input: hospital_transmission.csv, node_st398.csv and edge_st398.csv.
# Output: weight_df.csv and transmission-network PDFs.
