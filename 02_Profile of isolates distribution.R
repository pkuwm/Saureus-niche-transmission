...
# Summarize hospital isolate distribution by sampling site, season and source.
# Input: hospital_environment.csv.
# Output: Distribution plots, resistance/virulence violin plots and summary CSVs.
